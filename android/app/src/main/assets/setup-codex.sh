#!/data/data/com.rocdex.mobile/files/usr/bin/sh
#
...
#   3. Installs @openai/codex and codexapp globally via npm
#
# Exit codes:
#   0 = success
...
echo "[setup] Installing codexapp..."
npm install -g codexapp || {
    echo "[setup] ERROR: Failed to install codexapp"
    exit 2
}
