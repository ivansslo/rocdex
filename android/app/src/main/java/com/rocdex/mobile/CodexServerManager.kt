...
/**
 * Manages the lifecycle of the Node.js codexapp server process running
 ...
 * `codex login`, and the codexapp web server.
 */
...
WEOF
    ...
    fun installServerBundle(onProgress: (String) -> Unit): Boolean {
        val paths = BootstrapInstaller.getPaths(context)
        val targetDir = File(paths.prefixDir, "lib/node_modules/codexapp")
    ...
    /**
     * Start the codexapp server. The CONNECT proxy must be running
    ...
    fun startServer(): Boolean {
        ...
        val serverScript = "${paths.prefixDir}/lib/node_modules/codexapp/dist-cli/index.js"
